...
% calculate flip angles for CUBE
% output: Array with size [1,etl] with flip angles in degree
% input: T1 (ms), T2 (ms), TE (echo spacing) (ms), Starget (between 0-1, typically 0.23) and ETL

% this is an implementation of the algorithm as described in the appendix of Busse et al MRM (2006)
% http://onlinelibrary.wiley.com/doi/10.1002/mrm.20863/full

% example call: [angles] =  CUBEanglesdegree(1000,100,4,0.2,128);

% Henk Smit Erasmus MC h.smit@erasmusmc.nl
