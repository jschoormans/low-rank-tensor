clear; close all; clc
cd('L:\basic\divi\Ima\parrec\Jasper\LRT\Low_Rank_2018_02_07_VFA')
% recon T2-VFA copied from: recon_10_31_modfrom_5_9.m


%%

fn='lr_07022018_1749339_3_2_wip_brin-vfa-t2prep-lowrank_1mmV4.raw'
% fn='lr_07022018_1821220_5_2_wip_brin-vfa-t2prep-lowrankV4.raw' % brain Kerry 0.8 mm
% fn='lr_07022018_2015113_3_2_wip_3d_imsde_tseV4.raw'
clear MR
MR=MRecon(fn); 
...
%%
kspaceinput=kspace(:,:,:,:,1:end); %dummy pulses 

params=params_init();
params.L3=5;
params.L4=3;
params.subspacedim1=4;
...
subplot(222)
hold on
plot(TEvalues,squeeze(abs(P_recon(x1,y1,1,:,1))),'r')
plot(TEvalues,squeeze(abs(P_recon(x2,y2,1,:,1))),'b')
plot(TEvalues,squeeze(abs(P_recon(x3,y3,1,:,1))),'g')
plot(TEvalues,squeeze(abs(P_recon(x4,y4,1,:,1))),'y')
