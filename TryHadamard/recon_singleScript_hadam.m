...
RP.name            = '06_03_2018_3D_Flowphantomfully_y128z128c24_LRT_lambda0.05_mu0.05_alpha0.1_beta10_masky1z1C20_slice26_withhadam';
% RP.name            = '06_02_2018_FlowPhantomFully_from2017_11_28_y64z64c24_3D_hadamardtransform_fullnavigator_withmasky1z1C20_rank6.6.4_2Dslice26';
...
for cardframe = 1:size(mrecon.Data,6);
    ...
    mrecon.Data(:,:,:,:,:,cardframe,:,:,:,venc_dir) = bsxfun(@times,mrecon.Data(:,:,:,:,:,cardframe,:,:,:,venc_dir),permute(bart(sprintf(' poisson -Y64 -Z82 -y1 -z1 -C20 -v -e -s%d',seed)),[2 3 1]));
    seed = seed+1;
    end
end
...
tmp = mrecon.Data;
fprintf('sla tmp op als kspace voor later gebruik \n')
...
[P_recon,goldstandardscaled,C,G1,G2,G3] = LRT_recon_at_once_hadam(kspace,sens);
