...
G= init_G0(P1_0,Psi,Lg);    % first Lg vectors from left-dominant  svd of P10 Psi^H
C=G'*P1_0*conj(Psi);        % G0^H P10 Psi^H 
...
for iter=1:3    
    ...
    Gk=conj_grad(G,C,Ak,Bk,Y,Z) %17
    Ck=conj_grad(Gk,C,A,B,Y,Z) %18
